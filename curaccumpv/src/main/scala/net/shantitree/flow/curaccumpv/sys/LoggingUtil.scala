...
object LoggingUtil extends DML[CurAccumPVLog] {
  ...
  private[curaccumpv] def recordLog(log: CurAccumPVLog)(implicit g: OrientGraph): CurAccumPVLogVW = {
    g.addV(CurAccumPVLogVW, log)
  }

  private[curaccumpv] def recordProcess(comPeriod:Integer, saleOrders: Vector[SaleOrderHeaderVW])(implicit g: OrientGraph) : Option[CurAccumPVLogVW] = {
