...
object CurAccumPVProc {
  ...
  private [app] def updateAccumPV(comPeriod:Int, receivers: Traversable[(String, (BzNodeVW, PV))], log: CurAccumPVLogVW, regenerateAllFlag: Boolean)(implicit g: OrientGraph): Traversable[(String, BzNodeVW, PV)] = {
    log.setToSuccess()
